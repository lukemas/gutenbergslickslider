...
function wpb_add_google_fonts() {
   wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css2?family=Rubik:wght@300&display=swap', false );
   }
...
if ( function_exists( 'add_image_size' ) ) add_theme_support( 'post-thumbnails' );
	...
	add_image_size( 'slider-image-size', 332, 228, true );	
}
